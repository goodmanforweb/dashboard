    ...
    value: [
      {
        ...
        },
        {
            ...
            visible: true,
            belongTo: 'draw',
            option: [{name:'圆形',value:'circle'},{name:'方形',value:'rect'},{name:'三角形',value:'triangle'},{name:'菱形',value:'diamond'},{name:'图钉',value:'pin'},{name:'箭头',value:'arrow'}],
            defaultValue: 'circle',
      },
      {
            type: 'number',
      ...
      },
      {
        ...
        visible: true,
        belongTo: 'draw',
        option: [{name:'无',value:'auto',defaultValue: 'auto'},
      ...
      },
      {
            ...
            visible: true,
            belongTo: 'barPng',
            option: [{name:'无',value:'auto',defaultValue: 'auto'},{name:'线性',value:'line',defaultValue:'line'},{name:'指数',value:'exponential',defaultValue:'exponential'},{name:'对数',value:'logarithmic',defaultValue:'logarithmic'},{name:'多项式',value:0,defaultValue:1}],
            defaultValue: 'auto',
        }
    ]
  },
